...
fn main() {
    ...
    let mat_ground = Rc::new(Lambertian::new(Color::new(0.8,0.8,0.8)));
    ...
    // camera
    let camera = Camera::new(Point3::new(-2.0, 2.0, 1.0), Point3::new(0.0,0.0,-1.0), Point3::new(0.0,1.0,0.0),20.0, ASPECT_RATIO);
